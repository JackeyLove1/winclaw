    ...
    async def execute(self, **kwargs) -> ToolResult:
        ...
        try:
            ...
            async with asyncio.timeout(timeout):
                result = await self._session.call_tool(self._call_name, arguments=kwargs)
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            for tool in tools_list.tools:
                ...
                agent_name = f"{self.name}__{tool.name}"
...
def _determine_connection_type(server_config: dict) -> ConnectionType:
    ...
    if server_config.get("url") or server_config.get("serverUrl"):
...
async def load_mcp_tools_async(config_path: str = "mcp.json") -> list[Tool]:
    ...
    try:
        ...
        for server_name, server_config in mcp_servers.items():
            ...
            url = server_config.get("url") or server_config.get("serverUrl")
