...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.telegram.enabled:
            try:
                from winclaw.channels.telegram import TelegramChannel
        ...
        if self.config.channels.whatsapp.enabled:
            try:
                from winclaw.channels.whatsapp import WhatsAppChannel
        ...
        if self.config.channels.discord.enabled:
            try:
                from winclaw.channels.discord import DiscordChannel
        ...
        if self.config.channels.feishu.enabled:
            try:
                from winclaw.channels.feishu import FeishuChannel
        ...
        if self.config.channels.mochat.enabled:
            try:
                from winclaw.channels.mochat import MochatChannel
        ...
        if self.config.channels.dingtalk.enabled:
            try:
                from winclaw.channels.dingtalk import DingTalkChannel
        ...
        if self.config.channels.email.enabled:
            try:
                from winclaw.channels.email import EmailChannel
        ...
        if self.config.channels.slack.enabled:
            try:
                from winclaw.channels.slack import SlackChannel
        ...
        if self.config.channels.qq.enabled:
            try:
                from winclaw.channels.qq import QQChannel
        ...
        if self.config.channels.matrix.enabled:
            try:
                from winclaw.channels.matrix import MatrixChannel
