...
def mock_prompt_session():
    ...
    with (
        patch("winclaw.cli.commands._PROMPT_SESSION", mock_session),
        patch("winclaw.cli.commands.patch_stdout"),
    ):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with (
        patch("winclaw.cli.commands.PromptSession") as MockSession,
        patch("winclaw.cli.commands.FileHistory") as MockHistory,
